{{
	config(
		...
		tags=['SALESFORCE', 'EXT_SALESFORCE_OPPORTUNITYCONTACTROLE_INCR', 'EXT_SALESFORCE_OPPORTUNITYCONTACTROLE_INIT']
	)
}}
select * from (
	...
	( 
		...
		FROM {{ ref('SALESFORCE_DFV_VW_OPPORTUNITYCONTACTROLE') }} "TDFV_SRC"
...
select * from (
	...
	( 
		...
		FROM {{ source('SALESFORCE_INI', 'OPPORTUNITYCONTACTROLE') }} "INI_SRC"
