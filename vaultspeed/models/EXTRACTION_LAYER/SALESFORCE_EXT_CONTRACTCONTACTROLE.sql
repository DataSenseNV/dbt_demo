{{
	config(
		...
		tags=['SALESFORCE', 'EXT_SALESFORCE_CONTRACTCONTACTROLE_INCR', 'EXT_SALESFORCE_CONTRACTCONTACTROLE_INIT']
	)
}}
select * from (
	...
	( 
		...
		FROM {{ ref('SALESFORCE_DFV_VW_CONTRACTCONTACTROLE') }} "TDFV_SRC"
...
select * from (
	...
	( 
		...
		FROM {{ source('SALESFORCE_INI', 'CONTRACTCONTACTROLE') }} "INI_SRC"
