{{
	config(
		...
		tags=['SALESFORCE', 'EXT_SALESFORCE_PRICEBOOKENTRY_INCR', 'EXT_SALESFORCE_PRICEBOOKENTRY_INIT']
	)
}}
select * from (
	...
	( 
		SELECT 
			...
			, "TDFV_SRC"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
		...
		FROM {{ ref('SALESFORCE_DFV_VW_PRICEBOOKENTRY') }} "TDFV_SRC"
	...
	( 
		SELECT 
			...
			, "CALCULATE_BK"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
	...
	SELECT 
		...
		, "EXT_UNION"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
...
select * from (
	...
	( 
		SELECT 
			...
			, "INI_SRC"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
		...
		FROM {{ source('SALESFORCE_INI', 'PRICEBOOKENTRY') }} "INI_SRC"
	...
	( 
		SELECT 
			...
			, "LOAD_INIT_DATA"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
		...
		SELECT 
			...
			, CAST("MEX_EXT_SRC"."ATTRIBUTE_NUMBER" AS NUMBER) AS "USESTANDARDPRICE"
	...
	( 
		SELECT 
			...
			, "PREP_EXCEP"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
