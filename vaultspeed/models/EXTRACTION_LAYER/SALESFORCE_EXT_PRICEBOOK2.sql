{{
	config(
		...
		tags=['SALESFORCE', 'EXT_SALESFORCE_PRICEBOOK2_INCR', 'EXT_SALESFORCE_PRICEBOOK2_INIT']
	)
}}
select * from (
	...
	( 
		SELECT 
			...
			, "TDFV_SRC"."ISSTANDARD" AS "ISSTANDARD"
		FROM {{ ref('SALESFORCE_DFV_VW_PRICEBOOK2') }} "TDFV_SRC"
	...
	( 
		SELECT 
			...
			, "CALCULATE_BK"."ISSTANDARD" AS "ISSTANDARD"
	...
	SELECT 
		...
		, "EXT_UNION"."ISSTANDARD" AS "ISSTANDARD"
...
select * from (
	...
	( 
		SELECT 
			...
			, "INI_SRC"."ISSTANDARD" AS "ISSTANDARD"
		FROM {{ source('SALESFORCE_INI', 'PRICEBOOK2') }} "INI_SRC"
	...
	( 
		SELECT 
			...
			, "LOAD_INIT_DATA"."ISSTANDARD" AS "ISSTANDARD"
		...
		SELECT 
			...
			, CAST("MEX_EXT_SRC"."ATTRIBUTE_NUMBER" AS NUMBER) AS "ISSTANDARD"
	...
	( 
		SELECT 
			...
			, "PREP_EXCEP"."ISSTANDARD" AS "ISSTANDARD"
