{{
	config(
		...
		tags=['JDEDWARDS', 'STG_JDE_SOHEADERHIST_INCR', 'STG_JDE_SOHEADERHIST_INIT']
	)
}}
select * from (
	SELECT 
		  UPPER(MD5_HEX( "EXT_SRC"."SHDOCO_BK" || '\#' ||  "EXT_SRC"."SHDCTO_BK" || '\#' ||  "EXT_SRC"."SHKCOO_BK" || 
			'\#' )) AS "SALESORDERHEADERHISTORY_HKEY"
		...
		, UPPER(MD5_HEX( "EXT_SRC"."SHDOCO_BK" || '\#' ||  "EXT_SRC"."SHDCTO_BK" || '\#' ||  "EXT_SRC"."SHKCOO_BK" || 
			'\#' || 'JDE' || '\#' || "EXT_SRC"."ABAN8_FK_SHAN8_BK" || '\#' )) AS "LNK_SOHEADERHIST_ACCOUNT_HKEY"
		, UPPER(MD5_HEX( "EXT_SRC"."SHDOCO_BK" || '\#' ||  "EXT_SRC"."SHDCTO_BK" || '\#' ||  "EXT_SRC"."SHKCOO_BK" || 
			'\#' || "EXT_SRC"."MCMCU_FK_SHMCU_BK" || '\#' )) AS "LNK_SOHEADERHIST_BUSINESSUNITMASTER_HKEY"
	...
	FROM {{ ref('JDEDWARDS_EXT_F42019') }} "EXT_SRC"
