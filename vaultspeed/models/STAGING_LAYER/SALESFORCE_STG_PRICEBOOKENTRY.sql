{{
	config(
		...
		tags=['SALESFORCE', 'STG_SALESFORCE_PRICEBOOKENTRY_INCR', 'STG_SALESFORCE_PRICEBOOKENTRY_INIT']
	)
}}
select * from (
	SELECT 
		  UPPER(MD5_HEX( "EXT_SRC"."ID_BK" || '\#' )) AS "PRICEBOOKENTRY_HKEY"
		...
		, UPPER(MD5_HEX( "EXT_SRC"."ID_BK" || '\#' || "EXT_SRC"."ID_FK_CREATEDBYID_BK" || '\#' )) AS "LNK_PRICEBOOKENTRY_USER_CREATEDBYID_HKEY"
		, UPPER(MD5_HEX( "EXT_SRC"."ID_BK" || '\#' || 'SALESFORCE' || '\#' || "EXT_SRC"."ID_FK_PRODUCT2ID_BK" || '\#' )) AS "LNK_PRICEBOOKENTRY_PRODUCT_HKEY"
		, UPPER(MD5_HEX( "EXT_SRC"."ID_BK" || '\#' || "EXT_SRC"."ID_FK_LASTMODIFIEDBYID_BK" || '\#' )) AS "LNK_PRICEBOOKENTRY_USER_LASTMODIFIEDBYID_HKEY"
		, UPPER(MD5_HEX( "EXT_SRC"."ID_BK" || '\#' || "EXT_SRC"."ID_FK_PRICEBOOK2ID_BK" || '\#' )) AS "LNK_PRICEBOOKENTRY_PRICEBOOK2_HKEY"
		...
		, "EXT_SRC"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
	...
	FROM {{ ref('SALESFORCE_EXT_PRICEBOOKENTRY') }} "EXT_SRC"
