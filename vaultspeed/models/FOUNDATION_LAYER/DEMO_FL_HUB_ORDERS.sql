{{
	config(
		...
		alias='HUB_ORDERS',
		schema='DEMO_FL',
		unique_key = ['"ORDERS_HKEY"'],
		merge_update_columns = [],
		tags=['SALESFORCE', 'HUB_SALESFORCE_ORDERS_INCR', 'HUB_SALESFORCE_ORDERS_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."ORDERS_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER","CHANGE_SET"."LOAD_DATE",
