{{
	config(
		...
		schema='DEMO_FL',
		unique_key = ['"OPPORTUNITYCONTACTROLE_HKEY"'],
		merge_update_columns = [],
		tags=['SALESFORCE', 'HUB_SALESFORCE_OPPORTUNITYCONTACTROLE_INCR', 'HUB_SALESFORCE_OPPORTUNITYCONTACTROLE_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."OPPORTUNITYCONTACTROLE_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER",
