{{
	config(
		...
		alias='LKS_JDE_SODETAIL_ACCOUNT_SDSHAN_TMP',
		schema='JDEDWARDS_STG',
		tags=['JDEDWARDS', 'LKS_JDE_SODETAIL_ACCOUNT_SDSHAN_INCR']
	)
}}
select * from (
	WITH "DIST_STG" AS 
	...
	( 
		SELECT 
			  "STG_TEMP_SRC"."LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY" AS "LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY"
		...
		UNION 
		SELECT 
			  "LKS_SRC"."LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY" AS "LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY"
		...
		FROM {{ source('DEMO_FL', 'LKS_JDE_SODETAIL_ACCOUNT_SDSHAN') }} "LKS_SRC"
		INNER JOIN {{ source('DEMO_FL', 'LNK_SODETAIL_ACCOUNT_SDSHAN') }} "LNK_SRC" ON  "LKS_SRC"."LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY" = "LNK_SRC"."LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY"
	...
	SELECT 
		  "TEMP_TABLE_SET"."LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY" AS "LNK_SODETAIL_ACCOUNT_SDSHAN_HKEY"
		...
		, CASE WHEN "TEMP_TABLE_SET"."SOURCE" = 'STG' AND TO_CHAR("TEMP_TABLE_SET"."DELETE_FLAG") || TO_CHAR("TEMP_TABLE_SET"."ACCOUNT_SDSHAN_HKEY")
			= LAG( TO_CHAR("TEMP_TABLE_SET"."DELETE_FLAG") || TO_CHAR("TEMP_TABLE_SET"."ACCOUNT_SDSHAN_HKEY"),1)OVER(PARTITION BY "TEMP_TABLE_SET"."SALESORDERDETAIL_HKEY" ORDER BY "TEMP_TABLE_SET"."LOAD_DATE","TEMP_TABLE_SET"."ORIGIN_ID")THEN 1 ELSE 0 END AS "EQUAL"
