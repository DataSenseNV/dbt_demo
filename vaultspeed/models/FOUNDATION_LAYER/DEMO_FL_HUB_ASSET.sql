{{
	config(
		...
		alias='HUB_ASSET',
		schema='DEMO_FL',
		unique_key = ['"ASSET_HKEY"'],
		merge_update_columns = [],
		tags=['SALESFORCE', 'HUB_SALESFORCE_ASSET_INCR', 'HUB_SALESFORCE_ASSET_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."ASSET_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER","CHANGE_SET"."LOAD_DATE",
