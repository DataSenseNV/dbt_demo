{{
	config(
		...
		schema='DEMO_FL',
		unique_key = ['"CAMPAIGNMEMBER_HKEY"'],
		merge_update_columns = [],
		tags=['SALESFORCE', 'HUB_SALESFORCE_CAMPAIGNMEMBER_INCR', 'HUB_SALESFORCE_CAMPAIGNMEMBER_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."CAMPAIGNMEMBER_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER",
