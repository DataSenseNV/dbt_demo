{{
	config(
		...
		alias='LNK_SODETAILHIST_PRODUCT',
		schema='DEMO_FL',
		unique_key = ['"LNK_SODETAILHIST_PRODUCT_HKEY"'],
		merge_update_columns = [],
		tags=['JDEDWARDS', 'LNK_JDE_SODETAILHIST_PRODUCT_INCR', 'LNK_JDE_SODETAILHIST_PRODUCT_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	( 
		SELECT 
			  "STG_SRC1"."LNK_SODETAILHIST_PRODUCT_HKEY" AS "LNK_SODETAILHIST_PRODUCT_HKEY"
	...
	( 
		SELECT 
			  "CHANGE_SET"."LNK_SODETAILHIST_PRODUCT_HKEY" AS "LNK_SODETAILHIST_PRODUCT_HKEY"
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_SODETAILHIST_PRODUCT_HKEY" ORDER BY "CHANGE_SET"."LOAD_DATE",
	...
	( 
		SELECT 
			  "MIN_LOAD_TIME"."LNK_SODETAILHIST_PRODUCT_HKEY" AS "LNK_SODETAILHIST_PRODUCT_HKEY"
	...
	SELECT 
		  "MIV"."LNK_SODETAILHIST_PRODUCT_HKEY"
		, "MIV"."LOAD_DATE"
		, "MIV"."LOAD_CYCLE_ID"
		, "MIV"."PRODUCT_HKEY"
...
select * from (
	...
	( 
		SELECT 
			...
			, "CHANGE_SET"."PRODUCT_HKEY" AS "PRODUCT_HKEY"
			, "CHANGE_SET"."SALESORDERDETAILHISTORY_HKEY" AS "SALESORDERDETAILHISTORY_HKEY"
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."LNK_SODETAILHIST_PRODUCT_HKEY" ORDER BY "CHANGE_SET"."LOAD_CYCLE_ID",
