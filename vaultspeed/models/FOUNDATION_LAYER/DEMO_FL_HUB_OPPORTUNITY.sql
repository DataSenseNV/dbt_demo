{{
	config(
		...
		schema='DEMO_FL',
		unique_key = ['"OPPORTUNITY_HKEY"'],
		merge_update_columns = [],
		tags=['SALESFORCE', 'HUB_SALESFORCE_OPPORTUNITY_INCR', 'HUB_SALESFORCE_OPPORTUNITY_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."OPPORTUNITY_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER",
