{{
	config(
		...
		schema='DEMO_FL',
		unique_key = ['"SALESORDERDETAIL_HKEY"'],
		merge_update_columns = [],
		tags=['JDEDWARDS', 'HUB_JDE_SALESORDERDETAIL_INCR', 'HUB_JDE_SALESORDERDETAIL_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."SALESORDERDETAIL_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER",
