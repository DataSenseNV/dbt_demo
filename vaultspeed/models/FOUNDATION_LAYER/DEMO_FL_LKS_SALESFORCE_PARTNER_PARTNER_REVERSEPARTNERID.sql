{{
	config(
		...
		alias='LKS_SALESFORCE_PARTNER_PARTNER_REVERSEPARTNERID',
		schema='DEMO_FL',
		unique_key = ['"LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY"', '"LOAD_DATE"'],
		merge_update_columns = ['"LOAD_END_DATE"', '"DELETE_FLAG"', '"CDC_TIMESTAMP"'],
		tags=['SALESFORCE', 'LKS_SALESFORCE_PARTNER_PARTNER_REVERSEPARTNERID_INCR', 'LKS_SALESFORCE_PARTNER_PARTNER_REVERSEPARTNERID_INIT']
	)
}}
select * from (
	WITH "END_DATING" AS 
	( 
		...
		FROM {{ ref('SALESFORCE_STG_LKS_SALESFORCE_PARTNER_PARTNER_REVERSEPARTNERID_TMP') }} "LKS_TEMP_SRC_DK"
		WHERE  "LKS_TEMP_SRC_DK"."EQUAL" = 0
	)
	, "CALC_LOAD_END_DATE" AS 
	( 
		SELECT 
			  "LKS_TEMP_SRC_US"."LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY" AS "LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY"
			...
			, "LKS_TEMP_SRC_US"."REVERSEPARTNERID" AS "REVERSEPARTNERID"
		FROM {{ ref('SALESFORCE_STG_LKS_SALESFORCE_PARTNER_PARTNER_REVERSEPARTNERID_TMP') }} "LKS_TEMP_SRC_US"
	...
	( 
		SELECT 
			  "CALC_LOAD_END_DATE"."LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY" AS "LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY"
	...
	SELECT 
		  "FILTER_LOAD_END_DATE"."LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY"
...
select * from (
	...
	( 
		SELECT 
			  "STG_INR_SRC"."LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY" AS "LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY"
	...
	SELECT 
		  "STG_SRC"."LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY" AS "LNK_PARTNER_PARTNER_REVERSEPARTNERID_HKEY"
