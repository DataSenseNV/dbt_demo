{{
	config(
		...
		alias='HUB_CONTACT',
		schema='DEMO_FL',
		unique_key = ['"CONTACT_HKEY"'],
		merge_update_columns = [],
		tags=['SALESFORCE', 'HUB_SALESFORCE_CONTACT_INCR', 'HUB_SALESFORCE_CONTACT_INIT']
	)
}}
select * from (
	WITH "CHANGE_SET" AS 
	...
	( 
		SELECT 
			...
			, ROW_NUMBER()OVER(PARTITION BY "CHANGE_SET"."CONTACT_HKEY" ORDER BY "CHANGE_SET"."GENERAL_ORDER","CHANGE_SET"."LOAD_DATE",
