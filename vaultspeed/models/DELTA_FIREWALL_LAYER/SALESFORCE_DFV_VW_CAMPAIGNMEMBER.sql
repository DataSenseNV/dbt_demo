{{
	config(
		materialized='view',
		alias='VW_CAMPAIGNMEMBER',
		schema='SALESFORCE_DFV',
		tags=['view', 'SALESFORCE', 'SRC_SALESFORCE_CAMPAIGNMEMBER_TDFV_INCR']
	)
}}
	...
	( 
		SELECT 
			...
			, "CDC_SRC"."HASRESPONDED" AS "HASRESPONDED"
			...
			, "CDC_SRC"."FIRSTRESPONDEDDATE" AS "FIRSTRESPONDEDDATE"
		FROM {{ source('SALESFORCE_CDC', 'CDC_CAMPAIGNMEMBER') }} "CDC_SRC"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW_FILTER"."LEADID" AS "LEADID"
			...
			, "DELTA_VIEW_FILTER"."HASRESPONDED" AS "HASRESPONDED"
			...
			, "DELTA_VIEW_FILTER"."FIRSTRESPONDEDDATE" AS "FIRSTRESPONDEDDATE"
	...
	( 
		SELECT 
			...
			, COALESCE("DELTA_VIEW"."LEADID","MEX_BK_SRC"."KEY_ATTRIBUTE_VARCHAR") AS "LEADID"
			...
			, "DELTA_VIEW"."HASRESPONDED" AS "HASRESPONDED"
			...
			, "DELTA_VIEW"."FIRSTRESPONDEDDATE" AS "FIRSTRESPONDEDDATE"
	...
	SELECT 
		...
		, "PREPJOINBK"."HASRESPONDED" AS "HASRESPONDED"
		...
		, "PREPJOINBK"."FIRSTRESPONDEDDATE" AS "FIRSTRESPONDEDDATE"
