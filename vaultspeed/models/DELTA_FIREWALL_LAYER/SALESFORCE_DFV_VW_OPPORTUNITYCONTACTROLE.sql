{{
	config(
		materialized='view',
		alias='VW_OPPORTUNITYCONTACTROLE',
		schema='SALESFORCE_DFV',
		tags=['view', 'SALESFORCE', 'SRC_SALESFORCE_OPPORTUNITYCONTACTROLE_TDFV_INCR']
	)
}}
	...
	( 
		...
		FROM {{ source('SALESFORCE_CDC', 'CDC_OPPORTUNITYCONTACTROLE') }} "CDC_SRC"
