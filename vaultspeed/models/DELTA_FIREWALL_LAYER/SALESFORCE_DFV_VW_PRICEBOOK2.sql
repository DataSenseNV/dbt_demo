{{
	config(
		...
		tags=['view', 'SALESFORCE', 'SRC_SALESFORCE_PRICEBOOK2_TDFV_INCR']
	)
}}
	...
	( 
		SELECT 
			...
			, "CDC_SRC"."ISSTANDARD" AS "ISSTANDARD"
		FROM {{ source('SALESFORCE_CDC', 'CDC_PRICEBOOK2') }} "CDC_SRC"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW_FILTER"."ISSTANDARD" AS "ISSTANDARD"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW"."ISSTANDARD" AS "ISSTANDARD"
	...
	SELECT 
		...
		, "PREPJOINBK"."ISSTANDARD" AS "ISSTANDARD"
