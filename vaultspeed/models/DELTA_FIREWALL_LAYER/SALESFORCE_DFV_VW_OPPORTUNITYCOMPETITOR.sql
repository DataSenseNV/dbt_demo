{{
	config(
		materialized='view',
		alias='VW_OPPORTUNITYCOMPETITOR',
		schema='SALESFORCE_DFV',
		tags=['view', 'SALESFORCE', 'SRC_SALESFORCE_OPPORTUNITYCOMPETITOR_TDFV_INCR']
	)
}}
	...
	( 
		SELECT 
			...
			, "CDC_SRC"."COMPETITORNAME" AS "COMPETITORNAME"
			, "CDC_SRC"."STRENGTHS" AS "STRENGTHS"
			, "CDC_SRC"."WEAKNESSES" AS "WEAKNESSES"
		...
		FROM {{ source('SALESFORCE_CDC', 'CDC_OPPORTUNITYCOMPETITOR') }} "CDC_SRC"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW_FILTER"."COMPETITORNAME" AS "COMPETITORNAME"
			, "DELTA_VIEW_FILTER"."STRENGTHS" AS "STRENGTHS"
			, "DELTA_VIEW_FILTER"."WEAKNESSES" AS "WEAKNESSES"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW"."COMPETITORNAME" AS "COMPETITORNAME"
			, "DELTA_VIEW"."STRENGTHS" AS "STRENGTHS"
			, "DELTA_VIEW"."WEAKNESSES" AS "WEAKNESSES"
	...
	SELECT 
		...
		, "PREPJOINBK"."COMPETITORNAME" AS "COMPETITORNAME"
		, "PREPJOINBK"."STRENGTHS" AS "STRENGTHS"
		, "PREPJOINBK"."WEAKNESSES" AS "WEAKNESSES"
