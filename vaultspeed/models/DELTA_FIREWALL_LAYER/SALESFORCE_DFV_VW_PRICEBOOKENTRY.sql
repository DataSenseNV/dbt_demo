{{
	config(
		materialized='view',
		alias='VW_PRICEBOOKENTRY',
		schema='SALESFORCE_DFV',
		tags=['view', 'SALESFORCE', 'SRC_SALESFORCE_PRICEBOOKENTRY_TDFV_INCR']
	)
}}
	...
	( 
		SELECT 
			...
			, "CDC_SRC"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
		...
		FROM {{ source('SALESFORCE_CDC', 'CDC_PRICEBOOKENTRY') }} "CDC_SRC"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW_FILTER"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
	...
	( 
		SELECT 
			...
			, "DELTA_VIEW"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
	...
	SELECT 
		...
		, "PREPJOINBK"."USESTANDARDPRICE" AS "USESTANDARDPRICE"
