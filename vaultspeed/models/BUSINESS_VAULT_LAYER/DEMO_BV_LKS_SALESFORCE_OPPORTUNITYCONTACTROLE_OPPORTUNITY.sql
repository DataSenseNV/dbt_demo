{{
	config(
		...
		schema='DEMO_BV',
		tags=['view', 'BV', 'BV_LKS_SALESFORCE_OPPORTUNITYCONTACTROLE_OPPORTUNITY_BUSINESS_VIEW']
	)
}}
	SELECT 
	...
	FROM {{ ref('DEMO_FL_LKS_SALESFORCE_OPPORTUNITYCONTACTROLE_OPPORTUNITY') }} "DVT_SRC"
