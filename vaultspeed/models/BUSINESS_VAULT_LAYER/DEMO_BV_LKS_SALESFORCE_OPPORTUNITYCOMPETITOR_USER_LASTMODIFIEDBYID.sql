{{
	config(
		...
		schema='DEMO_BV',
		tags=['view', 'BV', 'BV_LKS_SALESFORCE_OPPORTUNITYCOMPETITOR_USER_LASTMODIFIEDBYID_BUSINESS_VIEW']
	)
}}
	SELECT 
	...
	FROM {{ ref('DEMO_FL_LKS_SALESFORCE_OPPORTUNITYCOMPETITOR_USER_LASTMODIFIEDBYID') }} "DVT_SRC"
